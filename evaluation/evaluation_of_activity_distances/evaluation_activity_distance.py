...
from evaluation.data_util.algorithm_activity_distances import (
...
def process_combination(args):
    ...
    activity_distance_matrix_dict = get_activity_distance_matrix_dict(
        activity_distance_function, logs_with_replaced_activities_dict
    )
...
if __name__ == '__main__':
    ...
    for log_name in log_list:
        ...
        for activity_distance_function in activity_distance_functions:
            ...
            ax.invert_yaxis()
            ax.set_title(activity_distance_function + ' - ' + log_name)
