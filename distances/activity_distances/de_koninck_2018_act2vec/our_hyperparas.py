...
def get_act2vec_distance_matrix_our(log, alphabet):
    model = gensim.models.Word2Vec(sentences=log, vector_size=256, window=3, min_count=0, epochs=50, sg=1, negative = 0)
