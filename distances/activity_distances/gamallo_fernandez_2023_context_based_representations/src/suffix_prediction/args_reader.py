...
def read_input_args() -> SuffixPredInputArgs:
    """
    Read the user input arguments
    :return: SuffixPredInputArgs object with the input arguments
    """

    parser = argparse.ArgumentParser(description="Execute the training of the "
                                                 "suffix prediction model")
    ...
    author_model.add_argument("--tax", help="Execute the Tax suffix prediction model",
                              action='store_true')
    author_model.add_argument("--camargo", help="Execute the Camargo suffix prediction model",
                              action='store_true')
    author_model.add_argument("--evermann", help="Execute the Evermann suffix prediction model",
                              action='store_true')
    ...
    return SuffixPredInputArgs(dataset, crossvalidation, author, emb_type,
